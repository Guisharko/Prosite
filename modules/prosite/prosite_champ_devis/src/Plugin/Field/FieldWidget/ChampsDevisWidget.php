...
namespace Drupal\prosite_champ_devis\Plugin\Field\FieldWidget;
 ...
 * )
 */
class ChampsDevisWidget extends WidgetBase
{
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state)
  {
    $element['designation'] = [
      ...
      '#title' => 'Désignation',
      '#empty_value' => '',
      '#default_value' => isset($items[$delta]->designation) ? $items[$delta]->designation : NULL,
    ];
    ...
    $element['quantite'] = [
      ...
      '#title' => 'Quantité',
      '#empty_value' => '',
      '#default_value' => isset($items[$delta]->quantite) ? $items[$delta]->quantite : NULL,
    ];
    ...
    $element['tva'] = [
      ...
      '#default_value' => isset($items[$delta]->tva) ? $items[$delta]->tva : NULL,
    ];
    ...
    $element['pu'] = [
      ...
      '#empty_value' => '',
      '#display' => 'hidden',
      '#default_value' => isset($items[$delta]->pu) ? $items[$delta]->pu : NULL,
    ];
...
//      '#title' => 'Prix total € HT',
//      '#empty_value' => '',
//      '#default_value' => isset($items[$delta]->pt) ? $items[$delta]->pt : NULL,
//    ];
